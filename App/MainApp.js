...
export default class MainApp {
    constructor() {
        ...
        this.fundDatas.forEach(x => {
            let fundBox = $(`<div class="fund-box"></div>`).appendTo(this.topFundSection);
